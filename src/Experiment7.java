...
public class Experiment7 {
	...
	final static String res = "results" + File.separator + Experiment7.class.getSimpleName() + File.separator;
	...
	public static void main(String[] args) throws Exception {
		...
		GaussGenerator psg = new GaussGenerator(permutationsInSet, permutationLength, rng);
		SeveralSwapsGenerator ssg = new SeveralSwapsGenerator(permutationsInSet, permutationLength, rng);
