...
public class Disagreement implements Serializable, Iterable<Permutation> {
	...
	public Disagreement(double[] hidenValues, Permutation[] permutations) {
		this.hidenValues = hidenValues.clone();
	...
	public Disagreement(Permutation... permutations) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Disagreement other = (Disagreement) obj;
	...
	public Permutation[] solve(Disagreement other) {
